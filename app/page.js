...
import { MessageCircle, BookOpen, Calendar, Shield, Users, Heart, ArrowRight, CheckCircle, Star, Menu, X } from 'lucide-react';
...
export default function Home() {
  ...
  const features = [
    {
      ...
      description: "Get immediate, confidential support whenever you need it. Our AI companion is trained to provide empathetic guidance.",
      href: "/chat"
    },
    {
      icon: <BookOpen className="w-6 h-6" />,
      title: "Self-Help Resources",
      description: "Access curated mental health resources, coping strategies, and wellness tools designed for students.",
      href: "/resources"
    },
    {
      icon: <Calendar className="w-6 h-6" />,
      title: "Professional Counseling",
      description: "Book sessions with licensed mental health professionals who understand student life challenges.",
      href: "/booking"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <section className="px-6 py-20">
        <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="inline-flex items-center bg-white/80 backdrop-blur-sm border border-indigo-200 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm text-indigo-700 font-medium">Confidential • Safe • Always Available</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            Get confidential help, connect with peers, and access professional resources - all in one safe space.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive mental health support designed with student life in mind
            </p>
          </div>
      ...
      <section id="about" className="px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 leading-relaxed">
            We understand the unique pressures of academic life. Clarity was created to provide accessible, 
            judgment-free mental health support that fits into your busy schedule.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Completely Private</h3>
              <p className="text-gray-600">Your conversations and data are encrypted and never shared</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Connect with other students who understand your experiences</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Heart className="w-8 h-8 text-purple-600" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Always Here</h3>
              <p className="text-gray-600">24/7 availability means support when you need it most</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Testimonials */}
      <section id="testimonials" className="px-6 py-20 bg-gradient-to-r from-indigo-50 to-purple-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              What Students Are Saying
            </h2>
            <p className="text-xl text-gray-600">Real stories from students who found support through Clarity</p>
          </div>
      ...
      <section className="px-6 py-20 bg-gradient-to-r from-indigo-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-indigo-100 mb-12 max-w-2xl mx-auto">
            Your mental health journey starts with a single conversation. We're here to support you every step of the way.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400">Supporting student mental health, one conversation at a time.</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="/booking" className="hover:text-white transition">Book Session</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mb-2">If you're in crisis, please contact:</p>
              <p className="text-white font-semibold">14416 - Tele MANAS Mental Health Support</p>
              <p className="text-white font-semibold">112 - Emergency Services</p>
            </div>
          </div>
          
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Clarity - Government of Jammu & Kashmir | Higher Education Department. All rights reserved.</p>
            <p className="mt-2 text-sm">Remember, seeking help is a sign of strength. You are not alone.</p>
          </div>
        </div>
      </footer>
    </div>
