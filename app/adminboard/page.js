      ...
      {isAdmin && (
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
            ...
            <p className="text-xs text-gray-500 mt-1">Professional bookings</p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-gray-900">Usage by Time</h3>
              <div className="flex items-center text-sm text-gray-500">
                <Clock className="w-4 h-4 mr-1" />
                Peak Hours
              </div>
              ...
              <div className="flex items-start p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    Sleep-related resources are highly requested but limited.
                    Consider expanding this category.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12 text-center text-gray-500">
          <p className="text-sm">
            ...
            Individual student information is never displayed or stored in
            identifiable form.
          </p>
        </div>
        </div>
