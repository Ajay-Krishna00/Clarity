  ...
  const counselors = [
    {
      ...
      about:
        "Specializes in helping students manage academic pressure and anxiety. Uses evidence-based approaches including CBT and mindfulness techniques.",
    ...
    },
    {
      ...
      about:
        "Focuses on helping young adults navigate relationships and build confidence. Specializes in group therapy and peer counseling approaches.",
      availability: generateAvailability(),
    },
    {
      id: 3,
      ...
      about:
        "Expert in trauma-informed care and culturally sensitive therapy. Helps students dealing with difficult life experiences and transitions.",
      availability: generateAvailability(),
    },
  ];
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-md">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Have you had therapy/counseling before?
                  </label>
                  <select
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700">
                      All information shared is confidential and protected under
                      government privacy policies. Your data is encrypted and
                      only accessible to your assigned counselor and necessary
                      medical personnel.
                    </p>
                  </div>
                </div>
