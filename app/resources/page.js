...
import { ArrowLeft, Search, Filter, Download, BookOpen, Video, Headphones, FileText, Heart, Star, Clock, Eye, ChevronRight, Tag } from 'lucide-react'
...
const ResourcesPage = () => {
  ...
  const mockResources = [
    {
      ...
      description: "Comprehensive strategies for handling academic pressure and exam anxiety. Includes breathing techniques, study schedules, and mindfulness exercises.",
      category: "academic",
      format: "pdf",
    ...
    },
    {
      ...
      description: "A guided introduction to mindfulness practices specifically designed for students. Learn to calm your mind and improve focus.",
      category: "anxiety",
      format: "video",
      duration: "20 min",
      downloads: 892,
    ...
    },
    {
      ...
      description: "Essential tips for better sleep quality during academic stress. Understand sleep cycles and create healthy bedtime routines.",
      category: "sleep",
      format: "article",
    ...
    },
    {
      ...
      description: "Recognize early signs of depression and learn about available support resources. Know when and how to seek professional help.",
      category: "depression",
      format: "pdf",
    ...
    },
    {
      ...
      description: "Navigate friendships, romantic relationships, and family dynamics while managing academic life. Communication and boundary-setting tips.",
    ...
    },
    {
      ...
      description: "Quick and effective breathing techniques you can use anywhere to reduce anxiety and stress in the moment.",
      category: "anxiety",
      format: "audio",
      duration: "12 min",
      downloads: 1001,
  ...
  const getFormatColor = (format) => {
    switch (format) {
      ...
      case 'pdf': return 'bg-blue-100 text-blue-700 border-blue-200';
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 py-4'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center'>
              ...
              <div>
                <h1 className='text-2xl sm:text-3xl font-bold text-gray-900'>Mental Health Resources</h1>
                <p className='text-sm text-gray-600'>Government of J&K • Higher Education Department</p>
              </div>
            </div>

            <div className="hidden sm:flex items-center bg-green-50 px-3 py-1 rounded-full">
              <Heart className="w-4 h-4 text-green-600 mr-1" />
              <span className="text-sm text-green-700 font-medium">Free Resources</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className='mb-12'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
              {featuredResources.map(resource => (
                <div key={resource.id} className='bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 group'>
                  <div className="relative">
                    <div className="h-48 bg-gradient-to-br from-indigo-100 to-purple-100 flex items-center justify-center">
                      <div className="text-4xl">📚</div>
                    </div>
                    <div className={`absolute top-3 left-3 flex items-center px-2 py-1 rounded-full text-xs border ${getFormatColor(resource.format)}`}>
          ...
          {loading ? (
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
              {filteredResources.map(resource => (
                <div key={resource.id} className='bg-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 group'>
                  <div className="relative">
                    <div className="h-40 bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center">
                      <div className="text-3xl">
                        ...
                        {!['anxiety', 'depression', 'academic', 'relationships', 'sleep'].includes(resource.category) && '📚'}
                      </div>
                    </div>
                    <div className={`absolute top-3 left-3 flex items-center px-2 py-1 rounded-full text-xs border ${getFormatColor(resource.format)}`}>
                      {getFormatIcon(resource.format)}
